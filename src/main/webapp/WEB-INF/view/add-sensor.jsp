...
<div class="row">
  <div class="col-md-5">
    ...
    <hr>
    <div class="row">
      <form method="post" action="${pageContext.request.contextPath}/wsn/addNode" class="form-horizontal">
  ...
  <div class="col-md-5 col-md-offset-1">
    ...
    <hr>
    <div class="row">
      <form method="post" action="${pageContext.request.contextPath}/wsn/addSensor" class="form-horizontal">
        <div class="form-group">
