...
$(document).ready(function() {
    ...
    $("#addserie").click(function() {
        ...
        chart.setTitle({
            text: 'Monthly Average Temperature (updated)'
        });
        if (chart.series.length === 2) {
            chart.addSeries({
            	name: 'B1 202',
                data: [94.1, 95.6, 54.4, 29.9, 71.5, 6.4, 29.2, 44.0, 76.0, 35.6, 48.5, 16.4]
            });
        }
    });
    // add data
    $("#adddata").click(function() {
        var chart = $('#sdata-container').highcharts();
        chart.setTitle({
            text: 'Monthly Average Temperature (updated 2)'
        });
...
addSdata = function(json) {
    ...
    var chart = $('#sdata-container').highcharts();
    chart.setTitle({
        text: 'Monthly Average Temperature (updated 2 From JSON)'
    });
    $.each(sdata, function() {
