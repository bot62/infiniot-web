...
$(document).ready(function() {
	$(".nd-div").each(function() {
		$(this).click(function() {
			$.post(projectName + "/wsn/getSensors", // action 
			{
				nid : $(this).attr("id")
			}, // parameter
			function(json) {
 ...
 */
addLiveStats = function(json, sname) {
	var stats = $.parseJSON(json);
	console.log('addLiveStats: ' + sname + ',' + stats.min + ',' + stats.max
