function changeDesc(filtre) {
  if (filtre == 'Weekly') {
    $('#container').highcharts({
      ...
      subtitle: {text: 'Source: Sensor 1 & Sensor 2 - PING32'},
      ...
      series: [
        {
          name: 'Sensor 1',
          data: [317.0, 386.9, 319.5, 264.5, 218.4, 221.5, 225.2]
        },
        {
          name: 'Sensor 2',
          data: [
      ...
      series: [
        {
          ...
          data: [
            ...
            9.6,  7.0, 6.9, 9.5,  14.5, 18.4, 21.5, 25.2, 26.5, 23.3, 18.3,
            13.9, 9.6, 6.9, 9.5,  14.5, 18.4, 21.5, 25.2, 26.5, 18.3
          ]
        },
        {
          name: 'Sensor 2',
          data: [
            ...
            4.8, 3.9, 4.2, 5.7, 8.5,  11.9, 15.2, 17.0, 16.6, 14.2, 10.3,
            6.6, 4.8, 3.9, 4.2, 5.7,  8.5,  11.9, 15.2, 17.0, 16.6
          ]
        }
      ]
    });
    ...
    $('#container').highcharts({
      chart: {type: 'line'},
      title: {text: 'Annualy Average Temperature'},
      subtitle: {text: 'Source: Sensor 1 & Sensor 2 - PING32'},
      xAxis: {
        categories: [
